    ...
    return Scaffold(
      ...
      body: const SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // Text(
            //   '${Strings.companyName} built the ${Strings.appName} app as a Free app. This SERVICE is provided by ${Strings.companyName} at no cost and is intended for use as is.',
